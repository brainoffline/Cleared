...
namespace Cleared.iOS
{
    ...
    {
		public static UIColor ToUIColor(this string hexValue, float alpha = 1.0f)
		{
			...
			switch (colorString.Length)
			{
				...
				default:
					throw new ArgumentOutOfRangeException(string.Format("Invalid color value {0} is invalid. It should be a hex value of the form #RBG, #ARGB, #RRGGBB, #AARRGGBB", hexValue));
